...
{
    /// <inheritdoc />
    public partial class addSubcriptionTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subcriptions_User_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Subcriptions_SubcriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subcribes_Subcriptions_SubcriptionId",
                        column: x => x.SubcriptionId,
                        principalTable: "Subcriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subcribes_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_SubcriptionId",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subcribes_SubcriptionId",
                table: "Subcribes",
                column: "SubcriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Subcribes_UserId",
                table: "Subcribes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Subcriptions_CreatedBy",
                table: "Subcriptions",
                column: "CreatedBy");
        }
