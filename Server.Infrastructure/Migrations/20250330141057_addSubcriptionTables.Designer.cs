...
namespace Server.Infrastructure.Migrations
{
    ...
    [Migration("20250330141057_addSubcriptionTables")]
    partial class addSubcriptionTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Domain.Entities.Notification", b =>
                {
                    ...
                    b.Property<string>("SpecificEntityChange")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Server.Domain.Entities.Subcribe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entities.Subcription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Server.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Server.Domain.Entities.User", "NotificationCreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("NotificationCreatedByUser");
                });

            modelBuilder.Entity("Server.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Server.Domain.Entities.Subcription", "Subcription")
                        .WithMany()
            ...
            modelBuilder.Entity("Server.Domain.Entities.Subcribe", b =>
                {
                    ...
                    b.HasOne("Server.Domain.Entities.User", "UserSubcribe")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("UserSubcribe");
                });

            modelBuilder.Entity("Server.Domain.Entities.Subcription", b =>
                {
                    b.HasOne("Server.Domain.Entities.User", "SubcriptionCreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("SubcriptionCreatedBy");
                });
